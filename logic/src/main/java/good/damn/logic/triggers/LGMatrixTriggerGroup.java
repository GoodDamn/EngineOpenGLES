...
public final class LGMatrixTriggerGroup
implements LGIMatrixTrigger {

    @NonNull
    private final MGMWrapperMatrix[] matrices;

    private LGMatrixTriggerGroup(
    ...
    private static class MGMWrapperMatrix {
       ...
       final float groupZ;
        ...
        @NonNull
        final LGMatrixTriggerMesh matrix;
    ...
    public static LGMatrixTriggerGroup createFromMatrices(
        @NonNull final LGMatrixTriggerMesh[] matrices
    ) {
        ...
        return new LGMatrixTriggerGroup(
            wrappers
        );
    }
}
